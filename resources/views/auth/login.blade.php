...
<head>
    ...
    <link id="pagestyle" href="{{ asset('admin/css/material-dashboard.css.map') }}" rel="stylesheet" />
    <!-- Font Awesome Icons -->
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('login') }}" class="text-start">
                                    ...
                                    <div class="form-check form-switch d-flex align-items-center mb-3">
                                        <input class="form-check-input" type="checkbox" for="remember" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} checked>
...
<script async defer src="https://buttons.github.io/buttons.js"></script>
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
<script src="{{asset('admin/js/material-dashboard.min.js=3.0.4')}}"></script>
<!-- Scripts -->
@yield('scripts')
