...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="{{ asset('vnpay/css/bootstrap.min.css') }}" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="{{ asset('vnpay/css/jumbotron-narrow.css') }}" rel="stylesheet">
        <script src="{{ asset('vnpay/css/jquery-1.11.3.min.js') }}"></script>
    </head>
